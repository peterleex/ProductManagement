...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 9277c3d5-d70c-47ab-b0af-f1afd0c8254d
```

> `9277c3d5-d70c-47ab-b0af-f1afd0c8254d` is the password of the certificate, you can change it to any password you want.
